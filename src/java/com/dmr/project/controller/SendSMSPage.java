...
import com.dmr.project.dao.Areas;
...
public class SendSMSPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Areas areaObject = new Areas();//get the first area 
        ArrayList<String> areas = areaObject.getAreas();
       // String firstArea = areas.get(0);
        
//        Transformers transformerObject = new Transformers();
//        ResultSet result= transformerObject.getData(firstArea);//get transformers locations
        

//        ArrayList<String> locationList = new ArrayList<>();
//        
//        while(result.next()){// add transformer_id`s to list
...
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet NewServlet at "+areas+locationList + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
